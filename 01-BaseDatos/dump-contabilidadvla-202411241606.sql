...
INSERT INTO `bitacora_partida_contable` VALUES (10,45,'2024-11-24 00:00:00',3,3,5450,5450,'nahum.martinez','NUEVA_PARTIDA','2024-11-24 17:54:38'),(11,41,'2024-11-23 00:00:00',3,4,5000,5000,'nahum.martinez','ANULA_PARTIDA','2024-11-24 19:05:54');
...
CREATE TABLE `libro_mayor` (
  `id_libro_mayor` bigint NOT NULL AUTO_INCREMENT,
  `cod_cuenta` int NOT NULL,
  `nombre_cuenta` varchar(300) DEFAULT NULL,
  `cod_movmaestro` bigint DEFAULT NULL,
  `cod_movdia` bigint DEFAULT NULL,
  `fecha_movdia` datetime DEFAULT NULL,
  `debe_movdia` double DEFAULT '0',
  `haber_movdia` double DEFAULT '0',
  `fecha_actualizacion` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_libro_mayor`),
  KEY `libro_mayor_catalogo_cuentas_FK` (`cod_cuenta`),
  KEY `libro_mayor_movimientos_maestros_FK` (`cod_movmaestro`),
  KEY `libro_mayor_movimientos_diarios_FK` (`cod_movdia`),
  CONSTRAINT `libro_mayor_catalogo_cuentas_FK` FOREIGN KEY (`cod_cuenta`) REFERENCES `catalogo_cuentas` (`cod_cuenta`),
  CONSTRAINT `libro_mayor_movimientos_diarios_FK` FOREIGN KEY (`cod_movdia`) REFERENCES `movimientos_diarios` (`cod_movdia`),
  CONSTRAINT `libro_mayor_movimientos_maestros_FK` FOREIGN KEY (`cod_movmaestro`) REFERENCES `movimientos_maestros` (`cod_movmaestro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `movimientos_diarios` VALUES (98,11010,'fdsfdsf','2024-11-23 00:00:00',5000,0,41,4),(99,11011,'asdfdssad','2024-11-23 00:00:00',0,5000,41,4),(100,11010,'dsasadasd','2024-11-23 00:00:00',10500,0,42,3),(101,11011,'sadsadsad','2024-11-23 00:00:00',0,10500,42,3),(102,2,'sadasdsad','2024-11-23 00:00:00',5450,0,42,3),(103,5,'sadsadsad','2024-11-23 00:00:00',0,5450,42,3),(104,11010,'dsafsafsad','2024-11-23 00:00:00',5000,0,43,3),(105,11011,'sadsad','2024-11-23 00:00:00',0,5000,43,3),(106,3,'dfsdfsdf','2024-11-22 00:00:00',10500,0,44,3),(107,11011,'dsafdsafasdf','2024-11-22 00:00:00',0,10500,44,3),(108,11010,'dsfsadfdsf','2024-11-24 00:00:00',5450,0,45,3),(109,11011,'dsfdsf','2024-11-24 00:00:00',0,5450,45,3);
...
INSERT INTO `movimientos_maestros` VALUES (41,'2024-11-23 00:00:00','2024-11-24 03:36:10','nahum.martinez',5000,5000,4),(42,'2024-11-23 00:00:00','2024-11-24 04:28:15','nahum.martinez',15950,15950,3),(43,'2024-11-23 00:00:00','2024-11-24 05:18:09','nahum.martinez',5000,5000,3),(44,'2024-11-22 00:00:00','2024-11-24 05:34:36','nahum.martinez',10500,10500,3),(45,'2024-11-24 00:00:00','2024-11-24 17:54:38','nahum.martinez',5450,5450,3);
...
-- Dump completed on 2024-11-24 16:06:48
